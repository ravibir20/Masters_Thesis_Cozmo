...
def funcnormalstatesaver(data):
    ...
    if do_not_disturb == 1:
        ...
        # with open('catkin_ws/src/cozmo/scripts/normal_save_list.csv', mode='a') as recorded_state2:   #newline=''
        #     write = csv.writer(recorded_state2)      #, delimiter=','
        #     write.writerow(normal_save_list)

        # df = pd.read_csv('catkin_ws/src/cozmo/scripts/normal_save_list.csv')

        #filename = "filewithcontents.csv"
        # opening the file with w+ mode truncates the file
        # f = open('catkin_ws/src/cozmo/scripts/normal_save_list.csv', "w")
        # f.truncate()
        # f.close()
        # os.remove('catkin_ws/src/cozmo/scripts/normal_save_list.csv')
        ...
        if perform_action == 1:
            ...
            #df.drop("Camera_Mood_Surprise", axis=1, inplace=True)
            #df.drop("Camera_Mood_Angry", axis=1, inplace=True)
